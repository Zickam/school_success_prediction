...
def get_grades_menu_keyboard() -> InlineKeyboardMarkup:
    """Get grades menu keyboard"""
    keyboard = [
        [
            InlineKeyboardButton(
                text="📚 Recent Grades",
                callback_data="grades_recent"
            )
        ],
        [
            InlineKeyboardButton(
                text="📝 Grades by Subject",
                callback_data="grades_subject"
            )
        ],
        [
            InlineKeyboardButton(
                text="📅 Grades by Period",
                callback_data="grades_period"
            )
        ],
        [
            InlineKeyboardButton(
                text="📊 Grade Statistics",
                callback_data="grades_stats"
            )
        ],
        [
            InlineKeyboardButton(
